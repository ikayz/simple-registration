...
<div class="container">
  ...
  <form role="form">
    <div class="form-group row">
      ...
      <div class="col-sm-3">
        <input type="text" name="" id="name" class="form-control" placeholder="Type name" required>
      </div>
    </div>
    <div class="form-group row">
      <label for="email" class="control-label col-sm-1 text-right">Email</label>
      <div class="col-sm-3">
        <input type="email" name="" id="email" class="form-control" placeholder="example@someone.com" required>
      </div>
    </div>
    <div class="form-group row">
      <label for="subject" class="control-label col-sm-1 text-right">Subject</label>
      <div class="col-sm-3">
        <input type="text" name="" id="subject" class="form-control" placeholder="Your subject" required>
      </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <label><input type="checkbox" name="" id="skills" class="checkbox-inline"> JavaScript</label>
        <label><input type="checkbox" name="" id="skills" class="checkbox-inline"> Node JS</label>
        <label><input type="checkbox" name="" id="skills" class="checkbox-inline"> React</label>
        <label><input type="checkbox" name="" id="skills" class="checkbox-inline"> PHP</label>
      </div>
    </div>
    <div class="form-group row">
